...
function lawyeria_lite_enqueue_style() {
    ...
    wp_enqueue_style( 'lawyeria_lite_fancybox', get_template_directory_uri() . '/css/jquery.fancybox.css', array(), '1.0' );
		wp_enqueue_style( 'custom', get_theme_file_uri('/css/custom.css') . null, '1.0', 'screen' );
		wp_enqueue_style( 'lato', 'https://fonts.googleapis.com/css?family=Lato:400,400i,700,700i,900' , null, n, 'screen' );

		wp_enqueue_style( 'foundation', get_theme_file_uri('/css/foundation.css') . null, null, 'screen' );
		wp_enqueue_style( 'twentytwenty', get_theme_file_uri('/css/twentytwenty.css') . null, null, 'screen' );
		wp_enqueue_style( 'twentytwenty-no-compass', get_theme_file_uri('/css/twentytwenty-no-compass.css') . null, null, 'screen' );
